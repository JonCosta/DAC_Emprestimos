...
var now = new Date();
var	date_months		= ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro',	'Novembro',	'Dezembro'];
var	date_dayCounts	= [	31,		   28,		  31,	   30,		31,	   30,	   31,	   31,		 30,		  31,		 30,		 31	];
var	date_dayNames	= ['Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado'];
...
function calendarInput(input) {
	...
	input.defaultValue='AAAA/MM/DD'; input.value='AAAA/MM/DD';
